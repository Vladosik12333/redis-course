...
public class RedisSchema {
	...
	static String getRateLimiterKey(
			String name, int minuteBlock,
			long maxHits
	) {
	...
	static String getRateSlidingLimiterKey(String windowSize, long name, long maxHits) {
		return KeyHelper.getKey(
				new StringBuilder("limiter:").append(":")
						.append(windowSize)
						.append(":")
						.append(name)
						.append(":")
	...
	// Redis type: sorted set
	static String getDayMetricKey(
			Long siteId, MetricUnit unit,
